...
1. Download the latest CityEngine for Houdini binary from the [release page](https://github.com/esri/palladio/releases).
...
1. Checkout CityEngine for Houdini: `git clone git@github.com:esri/palladio.git && cd palladio`
...
1. Checkout CityEngine for Houdini: `git clone git@github.com:esri/palladio.git`
